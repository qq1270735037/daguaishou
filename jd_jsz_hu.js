...
let jszhd ='{"Host": "apponlie.sahaj.cn","Connection": "keep-alive","Accept": "application/json","User-Agent": "Mozilla/5.0 (Linux; Android 10; Mi9 Pro 5G Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.72 MQQBrowser/6.2 TBS/045811 Mobile Safari/537.36 MMWEBID/8150 MicroMessenger/8.0.11.1980(0x28000B59) Process/tools WeChat/arm64 Weixin NetType/4G Language/zh_CN ABI/arm64","token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI3OTQwNmFlZi1iMTkyLTQxNGEtOTljNi02OGQ5N2JmYTE2MDUiLCJpYXQiOjE2MzMzMzA2NDQsImV4cCI6MTYzNTkyMjY0NH0.jdLFYGNulvp-Mr9VTgotEaV-PuQFjt9bZn5U6V6UwVg0qslcEBSNe1sECVnDcQ02NPGyRb3wuWdtU3PNH1z7FA","Origin": "http://qsbnb.sahaj.cn","Referer": "http://qsbnb.sahaj.cn/","Accept-Encoding": "gzip, deflate","Accept-Language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7"}'
let jszhds = ""
const logs =0;
    ...
    console.log(`------------- 共${jszhdArr.length}个账号-------------\n`)
      for (let i = 0; i < jszhdArr.length; i++) {
	    ...
	    await $.wait(15000)
          ...
          if (jszhd && jszhd.indexOf('@') > -1) {
            jszhdArr = jszhd.split('@');
